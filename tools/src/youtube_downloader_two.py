...
#FFMPEG_EXECUTABLE_PATH = r'C:\Path\To\Your\ffmpeg\bin\ffmpeg.exe'
    ...
    try:
        ...
        for i, video_url in enumerate(tqdm(playlist.video_urls, desc="Processing Videos", unit="video")):
            try:
                ...
                # filter for adaptive streams, only audio
                # order_by('abr') gets the audio by average bitrate
                ...
                if video_stream and audio_stream:
                    ...
                    if not os.path.exists(output_filename):
                        ...
                        try:
                            ...
                            # We need to ensure the file extensions are correct for ffmpeg
                            # For webm video, it's often better to re-encode to mp4 for compatibility
                            ...
                            merge_cmd_args = [
                                ...
                                '-strict', 'experimental', # For older ffmpeg versions with aac
                            ...
                            if video_stream.subtype == 'webm':
                                ...
                                # merge_cmd_args.insert(5, '-preset') # Encoding speed vs compression
                                # merge_cmd_args.insert(6, 'medium')  # e.g., ultrafast, medium, slow
